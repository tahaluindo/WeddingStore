...
import BgBase from "../../../public/static/tokyo/album-bg.png"
    ...
    return (
        <section className="relative">
            ...
            <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                <div className="mt-20">
                    <MapsLocation contents={contents.maps} btnColor='bg-[#a22b3c]'></MapsLocation>
                </div>
                <div className="flex flex-col justify-around h-[600px] relative">
                    <div className="px-10">
                        <div className="flex justify-center text-2xl font-[poppins] mt-10 text-white bg-[#a22b3c] rounded-full">Galeri Foto</div>
                    </div>
