...
import BgBase from "../../../public/static/tokyo/outro-bg.png"
import Border from "../../../public/static/tokyo/outro-border.svg"
import Divider from "../../../public/static/tokyo/outro-divider.png"
...
const Outro = ({contents}) => {
    return (
        <section className="relative">
            ...
            <div className="absolute h-full w-full flex flex-col justify-center bg-[#faced2]">
            </div>
