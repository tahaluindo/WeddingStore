...
import BgBase from "../../../public/static/tokyo/storyboards-bg.png"
import Road from '../../../public/static/tokyo/storyboards-road.svg'
            ...
            <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                <div className="flex flex-col h-full min-h-screen relative overflow-hidden min-w-full my-10">
                    <div className="flex justify-center pt-10 z-10">
                        <div className="bg-[#a22b3c] rounded-full px-16 font-bold z-10 text-white text-2xl font-[poppins]">Perjalanan Cinta</div>
                    </div>
                            ...
                            <div className="flex flex-col">
                                <div className="flex justify-center relative">
                                    <div className="flex items-center text-xs text-black w-[380px] min-h-[170px] font-['montserrat'] p-5 relative -left-10 bg-white rounded-r-full shadow-xl">
                                        ...
                                        <div className="flex justify-center items-center w-10 h-10 rounded-full bg-[#a22b3c]">
