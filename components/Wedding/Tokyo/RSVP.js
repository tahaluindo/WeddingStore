    ...
    return (
        <>
            <section className="relative">
                <div className="absolute h-full w-full min-h-screen bg-[#FFC0D0]">
                </div>
                <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                    <div className={`flex flex-col items-center mt-10 ${disabledClass} `}>
                        <div className="flex justify-center mt-8 z-10">
                            <div className="bg-[#a22b3c] rounded-full px-32 font-bold z-10 text-white text-2xl font-[poppins]">RSVP</div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            {(name === '') ?
                                ...
                                <button onClick={addRSVP} className="bg-[#a22b3c] w-[200px] h-[30px] font-bold text-sm hover:bg-blue-200 rounded-full text-white border-[1px] border-black">
                                    Kirim
                                </button>
                            }
                        </div>
