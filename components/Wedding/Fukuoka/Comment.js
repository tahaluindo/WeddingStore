...
import BgBase from '../../../public/static/fukuoka/comment-bg.png'
    ...
    return (
        <div className="bg-white">
            <div className="flex border-t-[1px] border-black w-full px-5 py-4">
                <div className="w-[20px] h-[20px] rounded-full bg-[#D0B95D]"></div>
                <div className="flex flex-col px-2">
                    <div className="flex flex-col">
                        <div className="flex text-xs">
                            <span className="font-extrabold text-[#D0B95D]">
                                {name}
                            </span>
                        </div>
                ...
                <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                    <div className="flex flex-col items-center mt-10">
                        <div className="flex justify-center mt-8 z-10">
                            <div className="bg-[#D0B95D] rounded-full px-5 font-bold z-10 text-white text-2xl font-[poppins]">Harapan dan Doa Restu</div>
                        </div>
                            ...
                            <div className="flex flex-col w-full p-5 pb-8 z-50">
                                ...
                                <div className="flex justify-center pt-5">
                                    {(name === '' || commentText === '') ?
                                        ...
                                        <button onClick={addComment} className="bg-[#D0B95D] w-[200px] h-[30px] font-bold text-sm hover:bg-white rounded-full text-white border-[1px] border-black">
                                            Kirim
                                        </button>
                                    }
                                </div>
