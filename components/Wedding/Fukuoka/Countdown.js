...
import Ring from '../../../public/static/fukuoka/countdown-ring.png'
// import Vline from '../../../public/static/fukuoka/countdown-vline.png'
        ...
        <section className={"relative"}>
            ...
            <div className="flex flex-col justify-center pt-56 h-full min-h-screen">
                ...
                <div className="flex justify-center mt-3 z-10">
                    <div className="flex flex-col justify-center items-center mr-3 bg-[#D0B95D] text-white h-[70px] w-[70px] rounded-2xl">
