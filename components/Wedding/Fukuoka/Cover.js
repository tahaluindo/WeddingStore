...
import BgBase from '../../../public/static/fukuoka/cover-bg.png'
import Bunga from '../../../public/static/fukuoka/cover-bunga.svg'
        ...
        <header className={open}>
            ...
            <div className="flex flex-col h-full min-h-screen justify-center">
                <div className="flex flex-col z-10 justify-center items-center">
                    <div className="text-[20px] text-white font-[Poppins] pb-3">Teruntuk</div>
                    <div className="text-[30px] text-white font-extrabold font-[playfairDisplay] tracking-[2px]">Calon Tamu</div>
                </div>
                ...
                <div className="flex flex-col z-10 justify-center items-center">
                    <div className="text-lg text-white text-center font-[poppins] pb-2">kamu diundang ke pernikahan</div>
                    <div className="font-bold text-3xl text-white text-center font-[playfair] pb-2">{`${contents.cewekName} & ${contents.cowokName}`}</div>
                </div>
