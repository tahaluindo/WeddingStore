...
import BgBase from "../../../public/static/fukuoka/agenda-bg.png"
...
const Agenda = ({ contents }) => {
    ...
    return (
        <section className="relative">
            <Image priority={true} layout="fill" src={BgBase.src} alt='BgTexture' objectFit='cover' objectPosition='bottom' />
