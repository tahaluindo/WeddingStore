    ...
    return (
        <>
            <section className="relative">
                <div className="absolute h-full w-full min-h-screen bg-black">
                </div>
                <AnimationOnScroll animateOnce={false} animateIn="animate__fadeInUpBig">
                    <div className={`flex flex-col items-center mt-10 ${disabledClass} `}>
                        <div className="flex justify-center mt-8 z-10">
                            <div className="bg-[#D0B95D] rounded-full px-32 font-bold z-10 text-white text-2xl font-[poppins]">RSVP</div>
                        </div>
                        <div className="flex text-sm justify-center font-[montserrat] font-bold w-[270px] pt-5 text-center z-10">
                            <div className="text-white">Kedatangan Bapak/Ibu/Saudara/i sangat berarti bagi kami, mohon konfirmasi kehadiran Bapak/Ibu/Saudara/i.
                                Terima kasih.</div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            {(name === '') ?
                                <button disabled className="bg-[#D0B95D] bg-opacity-25 w-[200px] h-[30px] font-bold text-sm rounded-full text-white border-[1px] border-black">
                                    Disabled
                                </button> :
                                <button onClick={addRSVP} className="bg-[#D0B95D] w-[200px] h-[30px] font-bold text-sm hover:bg-blue-200 rounded-full text-white border-[1px] border-black">
                                    Kirim
                                </button>
                            }
                        </div>
